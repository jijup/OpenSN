...
public:
    ...
    float manhattanDistance(glm::vec2 fromPoint, glm::vec2 *toCurve, float interval);
    float chebyshevDistance(glm::vec2 fromPoint, glm::vec2 *toCurve, float interval);
    float mahalanobisDistance(glm::vec2 fromPoint, glm::vec2 *toCurve, float interval);
